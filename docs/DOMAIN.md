...
- **WaiverManagementRun** is the Phase 8 ranked-acquisition workflow record. It retains the same provenance and preflight evidence plus per-action resolution: immediate free-agent mutations carry roster verification, while accepted waiver claims remain pending submissions.
